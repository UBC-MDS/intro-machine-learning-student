...
def test_4_2(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    assert answer.get_params()['cv'] == 10, "Make sure you are using 10-fold cross validation."
...
def test_4_6(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    assert sha1(str(answer).encode('utf8')).hexdigest() == "97cdbdc7feff827efb082a6b6dd2727237cd49fd", "Your answer is incorrect. Please try again."
    return("Success")
